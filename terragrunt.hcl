locals {
  ...
  assume_role_arn = "arn:aws:iam::863139717802:policy/scaffolding-terragrunt/scaffolding-terragruntRemoteStateReadWrite"
  ...
  # current_terragrunt = read_terragrunt_config("terragrunt.hcl")
}
